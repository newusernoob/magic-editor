var home = `<div class="auto"> <div class="center"> <label onclick="page(projects);">meus projetos</label> <label onclick="page(configurations);">configurations</label> </div> </div>`;
var configurations = ``;
var home = `<div class="auto"> <div class="center"> <label onclick="page(projects);">meus projetos</label> <label onclick="page(configurations);">configurações</label> </div> </div>`;
